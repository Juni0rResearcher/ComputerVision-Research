...
Основа реализации и логика экспериментов соответствуют материалам исследования (см. `main-2.pdf`) и исходным ноутбукам в `drafts/`.

## Связь со статьей
Для описания методов, постановки задачи и интерпретации результатов используйте статью:
- `main-2.pdf` (рукопись исследования)
